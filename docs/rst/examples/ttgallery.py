...
class Gui(object):
    ...
    def makeGui(self):
        ...
        # Text Box
        self.gui.addText('ttext', 60, 5, 'Text Box')
    ...
    def makeSimple(self):
        ...
        self.simplePage.addSpin('ttspin2', [[2,1,10]], '', 'Single Spin')
        self.simplePage.set('ttspin2', [2])
        self.simplePage.plot('ttspin2', row=11)
    ...
    def collect(self):
        ...
        result += str(self.simplePage.get('ttspin2')) + '\n\n    '
        ...
        result += str(self.subwin.get('ttcollector')) + '\n    '
        # Progress Bar
